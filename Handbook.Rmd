...
ToC <- data.frame(Week = c(1:11),
                  ...
                  Topic = c("What do we mean by women's mental health?","Fundamentals of female physiology","Sex/gender differences in psychology","Sociocultural impacts on women's health", "Menstrual and mental health", "Perinatal mental health", "Menopause and mental health", "Fertility and mental health", "Psychiatric disorders in women", "Research sandpit: depression & anxiety", "Deep dive: eating disorders"),
...
The exam will take the form of a timed essay and will comprise 60% of the marks for the module. 
